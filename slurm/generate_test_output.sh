...
## EXAMPLE: ./slurm/generate_test_output.sh 2 1 1 0.00 tests/tinkywinky.in
...
EVALUATE=0 SEQ=1 sbatch --nodes 1 --ntasks 1 --time 00:05:00 --partition xw-2245 --constraint xw-2245 -o $output_file -e $output_file slurm/config1.sh $@